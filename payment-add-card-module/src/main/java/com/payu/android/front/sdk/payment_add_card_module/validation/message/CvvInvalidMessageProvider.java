...
public class CvvInvalidMessageProvider implements ValidationErrorProvider {

    private final Translation mTranslation = TranslationFactory.getInstance();

    @Override
    public String getEmptyValueString() {
        return mTranslation.translate(TranslationKey.INVALID_CVV_EMPTY);
    }

    @Override
    public String getInvalidValueString() {
        return mTranslation.translate(TranslationKey.INVALID_CVV_ERROR);
    }
}
