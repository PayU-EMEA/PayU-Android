...
public class CardOrActivePblPaymentMethodPredicateTest {
    private CardOrActivePblPaymentMethodPredicate objectUnderTest;

    @Before
    public void setUp() {
        objectUnderTest = new CardOrActivePblPaymentMethodPredicate();
    }
    ...
    @Test
    public void shouldReturnTrueForExpiredCardPayment() {
        //given
    ...
    @Test
    public void shouldReturnTrueForEnabledPblPayment() {
        //given
    ...
    @Test
    public void shouldReturnFalseForDisabledPblPayment() {
        //given
